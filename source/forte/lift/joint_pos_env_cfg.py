...
@configclass
class ForteCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        #self.scene.robot = Forte_ENV_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.commands.object_pose.body_name = "l_end_effector_link"
...
@configclass
class ForteCubeLiftEnvCfg_PLAY(ForteCubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
