...
class DashRewards():
    ...
    # -- penalties
    #joint_t_pose_l2 = RewTerm(func=mdp.joint_t_pose_l2, weight = -1.0)
    #joint_t_pose = RewTerm(func=mdp.joint_t_pose, weight = 1.0)

    lin_vel_z_l2 = RewTerm(func=mdp.lin_vel_z_l2, weight=-2.0)
    ang_vel_xy_l2 = RewTerm(func=mdp.ang_vel_xy_l2, weight=-0.05)
    dof_torques_l2 = RewTerm(func=mdp.joint_torques_l2, weight=-1.0e-5)
    dof_acc_l2 = RewTerm(func=mdp.joint_acc_l2, weight=-2.5e-7)
    action_rate_l2 = RewTerm(func=mdp.action_rate_l2, weight=-0.01) # More action change = penalty
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*_upper_leg", ".*_lower_leg", ".*_upper_arm", ".*_lower_arm"]), "threshold": 1.0},
    )
    # -- optional penalties
    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-1.0)
    
    #flat_feet_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=1.0)
...
class DashRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        #self.commands.base_velocity.ranges.lin_vel_x = (2, 5)
        #self.commands.base_velocity.ranges.lin_vel_y = (-0.5, 0.5)
        #self.commands.base_velocity.ranges.ang_vel_z = (-1.0, 1.0)
